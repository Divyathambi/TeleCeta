          ...
          (either) => either.fold(
            (failure) {
              FlushbarHelper.createError(
                message: failure.map(
                  invalidEmailAndPasswordCombination: (_) => "Please make sure you've entered valid credentials.", 
                  phoneNumberAlreadyExists: (_) => "This phone number already exists.", 
                  emailAlreadyExists: (_) => "This email is already in use.", 
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  validator: (_) => context.read<SignInFormBloc>()
                                           ...
                                           .value.fold(
                                            (f) => f.maybeMap(
                                              invalidPassword: (_) => "Password should contain atleast 8 characters",
                                              empty: (_) => "This field cannot be empty",
                                              orElse: () => null
                                              ), 
                                            (r) => null
