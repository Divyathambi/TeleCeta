...
mixin _$Doctor {
  ...
  List<TimeSlots>? get timeSlots => throw _privateConstructorUsedError;
...
class _$_Doctor extends _Doctor with DiagnosticableTreeMixin {
  const _$_Doctor(
      {this.id,
      this.name,
      this.email,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('highestQualification', highestQualification))
      ..add(DiagnosticsProperty('nameOfClinic', nameOfClinic))
      ..add(DiagnosticsProperty('location', location))
      ..add(DiagnosticsProperty('experience', experience))
      ..add(DiagnosticsProperty('profilePic', profilePic))
      ..add(DiagnosticsProperty('certificatePics', certificatePics))
...
abstract class _Doctor extends Doctor {
  const factory _Doctor(
      ...
      String? description,
      List<TimeSlots>? timeSlots,
      List<Reviews>? reviews}) = _$_Doctor;
